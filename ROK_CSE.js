...
var expText = {
    ...
    "instructionsHun1": `<div class = "frame"><h1>Feladat</h1><h4>A képernyőn különböző irányba mutató és mozgó nyilakat fogsz látni.
                A feladatod az lesz, hogy a nyilak <i><b>mozgásirányára</b></i> reagálj. Ezt minél gyorsabban és pontosabban tedd!</h4>
                <h4>A nyilak <i><b>többsége</b></i> fog azonos irányba mozogni, a többi véletlenszerűen.</h4>
                <h4>Kérlek, a nyilak <i><b>többségének mozgásirányának</b></i> megfelelő gombot nyomd meg a billentyűzeten.</h4>
                <h2>Vigyázz!</h2>
    ...
    "instructionsHun2": `<div class="frame"><h3>Amikor a nyilak által mutatott irány és a mozgás iránya megegyezik:</h3>
                <div class="animFrame">
    ...
    "instructionsHun3": `<div class = "frame"><h3> Ha a nyilak <b>balra</b> mozognak, nyomd meg az <span class ='key'>A</span> billentyűt! </h3> 
    ...
    "instructionsEn1": `<div class = "frame"><h1>Task</h1><h4>You will see arrows on the screen pointing and moving in different directions.
                Your task is to react to the direction in which the arrows 
                are <i><b>moving</b></i> as quickly and as accurately as possible.</h4>
                <h4>The <i><b>majority</b></i> of the arrows will move in the same direction, while the rest of them will float on the screen randomly.</h4>
                <h4>Please press the key on your keyboard that corresponds to the direction in which the <i><b>majority</b></i> of the arrows are <i><b>moving</b></i>.</h4>
                <h2>Be careful!</h2>
    ...
    "instructionsEn2": `<div class="frame"><h3>When the arrows point and move the same way:</h3>
                <div class="animFrame">
                <img src="arrow1.png" class="animCongruent">
                </div>
    ...
    "instructionsEn3": `<div class = "frame"><h3>If the arrows are moving to the <i>left</i>, press the <span class='key'>A</span> key.</h3> 
